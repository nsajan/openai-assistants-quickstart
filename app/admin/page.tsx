...
const AdminPage = () => {
  ...
  return (
    <div className={styles.main}>
      ...
      <button className={styles.primaryButton} onClick={fetchAssistants}>
        Refresh
      </button>
      ...
      {selected && (
        <div className={styles.details}>
          ...
          <div>
            ...
            />
            <div>
              <button className={styles.primaryButton} onClick={updateInstructions}>
                Update Instructions
              </button>
              <button
                className={`${styles.primaryButton} ${styles.spacedButton}`}
          ...
          <div className={styles.functions}>
                ...
                .map((t: any) => (
                  <li key={t.function.name}>
                    ...
                    <button
                      ...
                      onClick={() => removeFunction(t.function.name)}
                    >
                      Remove
                    </button>
                  </li>
            ...
            <div>
              ...
              />
              <button className={styles.primaryButton} onClick={addFunction}>
                Add Function
              </button>
            </div>
          </div>
